...
class Critic:
    ...
    def build_model(self):
        ...
        Q_values = layers.Dense(units=self.action_size,
                                name='q_values',
...
class DDPG():
    ...
    def __init__(self, task):
        ...
        self.exploration_theta = 0.6
        self.exploration_sigma = 0.8
    ...
    def act(self, state):
        ...
        return list(action + self.noise.sample()*self.noise_amount)  # add some noise for exploration
